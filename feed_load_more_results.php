...
$fatassquery = mysql_query("SELECT * FROM `social_feed` WHERE ( `postedby`='0' ".$querybuilder.") AND `visible`='1' AND (`id` < ".$id12.") ORDER BY `id` DESC LIMIT 0,30") or die(mysql_error());
